...
const clothes = [
    ...
    {path: "images/lightblueshortjeans.jpg", type: "bottoms", length: "short"},
    {path: "images/beigesandals.jpg", type: "shoes", length: ""},
    {path: "images/greendress.jpg", type: "onepiece", length: ""},
    {path: "images/flowerromper.jpg", type: "onepiece", length: ""},
    {path: "images/greytshirt.jpg", type: "tops", length: "short"},
    {path: "images/stripedpants.jpg", type: "bottoms", length: "long"},
    {path: "images/jaguarprinttop.jpg", type: "tops", length: "short"},
    {path: "images/rainjacketblack.jpg", type: "jackets", length: ""},
]
